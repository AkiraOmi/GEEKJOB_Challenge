...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <%
        ...
        String previousAddress = (request.getAttribute("previousAddress") == null) ? "./top.jsp" : 
                (String)request.getAttribute("previousAddress"); //ログイン前に見ていたページのアドレス格納用
        request.setAttribute("previousAddress",previousAddress);
    %>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="" method="POST">
                <input type="submit" class="btn btn-primary" value="直前のページに戻る">
            </form>
        </div>
        <% } %>
    </body>
