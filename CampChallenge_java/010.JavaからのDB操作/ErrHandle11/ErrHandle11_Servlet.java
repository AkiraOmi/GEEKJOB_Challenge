 ...
 * @author guest1Day
 */
public class ErrHandle11_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = 0; //ID確認用変数
        boolean isRightInput = true; // 表記にミスがあったかの確認  
        boolean isSucceeded = true; //  更新できたかどうかの確認
        ...
        String result = "/WEB-INF/jsp/ErrHandle11_Result.jsp"; // 結果表示ページパス
        ...
        try{
            ...
            //INSERT部分
            db_st1 = db_con.prepareStatement("UPDATE profiles SET name = ?,tell = ?,age = ?,birthday = ? WHERE profileID = ?");
            ...
            // JavaBeansにデータを格納
            ErrHandle11_Beans beans = new ErrHandle11_Beans();
            beans.setIsRightInput(isRightInput);
            beans.setIsSucceeded(isSucceeded);
