 ...
 * @author guest1Day
 */
@WebServlet(urlPatterns = {"/ErrHandle3"})
public class ErrHandle3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ErrHandle3</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try{
                ...
                if(!found){
                    out.print("データが見つかりません。もしくはテーブルが見つかりません<br>");
                }
                if(db_data != null){
                    db_data.close();
                }
