 ...
 * @author guest1Day
 */
@WebServlet(urlPatterns = {"/ErrHandle4"})
public class ErrHandle4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ErrHandle4</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try{
                ...
                try{
                    ...
                    out.println("クローズエラー：" + e_sql.getMessage());
                }
            }
            out.println("</body>");
            out.println("</html>");
