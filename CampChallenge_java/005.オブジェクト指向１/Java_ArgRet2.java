 ...
 * @author guest1Day
 */
@WebServlet(urlPatterns = {"/Java_ArgRet2"})
public class Java_ArgRet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for(int i = 1; i <= 4;i++){
                out.println(i + "人目のプロフィールです<br>");
                LinkedHashMap<String,String> map = getProfile(i);
